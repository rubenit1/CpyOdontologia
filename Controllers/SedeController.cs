...
public sealed class SedeController : ControllerBase
{
    private readonly SedeRepo _repo;
    public SedeController(SedeRepo repo) => _repo = repo;

    [HttpGet] // activos
    public async Task<ActionResult<IEnumerable<SedeDto>>> GetActivas()
    ...
    [HttpPost]
    public async Task<IActionResult> Post([FromBody] SedeCreateDto dto)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Put(int id, [FromBody] SedeUpdateDto dto)
    {
