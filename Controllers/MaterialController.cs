...
public sealed class MaterialController : ControllerBase
{
    ...
    public MaterialController(MaterialRepo repo) => _repo = repo;

    [HttpGet] // activos
    public async Task<ActionResult<IEnumerable<MaterialDto>>> GetActivos()
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Put(int id, [FromBody] MaterialUpdateDto dto)
    {
