...
public sealed class GeneroController : ControllerBase
{
    private readonly GeneroRepo _repo;
    public GeneroController(GeneroRepo repo) => _repo = repo;

    [HttpGet] // activos
    public async Task<ActionResult<IEnumerable<GeneroDto>>> GetActivos()
    ...
    [HttpPost]
    public async Task<IActionResult> Post([FromBody] GeneroCreateDto dto)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Put(int id, [FromBody] GeneroUpdateDto dto)
    {
